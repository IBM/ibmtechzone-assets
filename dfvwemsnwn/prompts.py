# object_prompt_start = """
# Given a Selenium script, extract the following information:
# ObjectName: The name of the object or element being interacted with in the Selenium script.
# PropertyName: Extract the specific attribute or property being accessed or modified in the Selenium script (e.g., id, class, name, etc.).
# PropertyValue: Retrieve the value associated with the property mentioned above in the Selenium script (e.g., the value of the 'id' attribute, the text entered into an input field, etc.).
# Your task is to accurately parse the Selenium script and provide the object name, property name, and property value for each relevant interaction within the script.
# Enclose the value between \" \" when there is a value assignment in property value.
# Input:
# public static WebElement Vivek(WebDriver driver) {
#  waitforObject();
#  WebElement element = driver.findElement(By.xpath("//TD[normalize-space(text())='Vivek']"));
#  return element;
# 	}
# Output:
# {
# "objectName": "Vivek",
# "propertyName": "XPath",
# "propertyValue": "//TD[normalize-space(text())=\"Vivek\"]"
# }
# Input:
...
# object_prompt_start = """Extract the following information from the given Selenium script containing multiple classes and functions:

# For each method, including those representing web elements:
# - objectClass: The class of the web element (e.g., "WebEdit", "WebList", etc.).
# - objectName: The name of the method representing the web element.
# - propertyName: The property used to locate the web element (e.g., "id", "xpath", etc.).
# - propertyValue: The value of the property used to locate the web element.

# Ensure comprehensive scanning of the script to extract all declared web elements and those accessed through methods.

# Note:
# - The objectClass can be one of the following: "WebEdit", "WebList", "WebRadioButton", "WebLink", "WebButton", "Page", "WebCheck", "Frame".
