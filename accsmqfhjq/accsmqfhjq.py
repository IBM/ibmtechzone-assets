...
COS_HMAC_ACCESS_KEY_ID = os.environ["cos_hmac_access_key_id"]
COS_HMAC_SECRET_ACCESS_KEY = os.environ["cos_hmac_secret_access_key"]
...
class COSClient:
    def __init__(self):
        ...
        print("Successfully connected with IBM COS Client!!")
...
class COSClientV2:
    def __init__(self):
        ...
        print("Successfully connected with IBM COS Client with provided HMAC keys!!")
...
cos_client_v1 = COSClient()
cos_client_v2 = COSClientV2()