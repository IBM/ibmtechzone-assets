...
- Be clear & direct: Provide clear instructions and context to guide Watson's responses
- Use examples: Include examples in your prompts to illustrate the desired output format or style
- Give AI a role: Prime Watson to inhabit a specific role (like that of an expert) in order to increase performance for your use case
...
- Let the AI think: Encourage step-by-step thinking to improve the quality of Watson's output
- Prefill Ai's response: Start AI's response with a few words to guide its output in the desired direction
...
Instruction prompt for the above task:
