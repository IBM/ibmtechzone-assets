...
- Give AI a role: Prime Claude to inhabit a specific role (like that of an expert) in order to increase performance for your use case
...
- Let the AI think: Encourage step-by-step thinking to improve the quality of Claude's output
...
if __name__ == '__main__':
    print(META_PROMPT.format(task="dsfdsgfergve"))